...
// Só vai alterar a visibilidade do botão de menu em telas maiores
function setupMenuToggle() {
    if (window.innerWidth > 400) { // 400px é o ponto de corte que definimos
        ...
        // Remove completamente o botão de menu em telas pequenas
        menuToggle.style.display = 'none';
        nav.classList.add('active'); // Garante que o nav fique visível
    }
}
...
function animateSkillBars() {
    ...
    // Anima apenas uma vez quando a seção ficar visível
    const animateOnce = () => {
        if (isSectionVisible()) {
